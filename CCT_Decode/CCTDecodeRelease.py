...
def parse_args():
    ...
    parser.add_argument('--bach', dest='bach',
                        help='bach processing or not',
...
if __name__ == '__main__':  
    ...
    if not args.bach:
        ...
        code_table,processed_img=CCT_extract1(raw_img,args.bit_n,args.threshold)
        save_path=os.path.join(args.save_folder,args.filename)
        cv2.imwrite(save_path,processed_img)
#        print(code_table)
    if args.bach:
        scanne_data_dir(args.src_folder,args.save_folder,args.bit_n,args.threshold)
